...
- [[PHP]] is (sadly for me) dynamically-typed, so it permits [type-juggling](https://www.phptutorial.net/php-tutorial/php-type-juggling/), I can't but that shit here, f
