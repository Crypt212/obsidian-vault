...
- **HTTP** *requests/responses* are have some rules, they are sent using **data serialization formats** (like [[MindMap/Software Engineering/Serialization Format/JSON]], [[XML]], ...etc).
# HTTP Versions
