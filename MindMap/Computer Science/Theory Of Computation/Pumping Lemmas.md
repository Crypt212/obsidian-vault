...
- **Intuition**: automata recongizing strings in regular languages need to hold no memory any previous states, they only hold loops, so if the there are no strings can't be constructed by looping over any internal part of other string in a language