...
- **Formal Language**: a set of **strings** that could be g over an **alphabet**.
...
language is not regular. It provides a property that all regular languages

must satisfy, and if a language does not satisfy this, it is not regular. Pump-
