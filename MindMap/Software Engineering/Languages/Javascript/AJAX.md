...
> Note that it supports [[XML]], [[MindMap/Software Engineering/Serialization Format/JSON]] and many more, the name is just historical.
# How it works
...
4. - **Server Processes the Request:** The server receives the request, does something, and prepares a response, usually in **[[MindMap/Software Engineering/Serialization Format/JSON]]** or **[[XML]]** format.
