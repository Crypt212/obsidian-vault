...
- _Compound types_ can group multiple values into one type. Rust has two primitive compound types: [[Tuples]] and [[MindMap/Software Engineering/Languages/Rust/Arrays|Arrays]].
## 
# References
